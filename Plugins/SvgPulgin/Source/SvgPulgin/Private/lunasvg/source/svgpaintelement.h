...
public:
    ...
    bool hasGradientTransform() const { return m_gradientTransform != nullptr; }
    bool hasSpreadMethod() const { return m_spreadMethod != nullptr; }
    bool hasGradientUnits() const { return m_gradientUnits != nullptr; }
    bool hasGradientContentElement() const { return m_gradientContentElement != nullptr; }
...
public:
    ...
    bool hasX1() const { return m_x1 != nullptr; }
    bool hasY1() const { return m_y1 != nullptr; }
    bool hasX2() const { return m_x2 != nullptr; }
    bool hasY2() const { return m_y2 != nullptr; }
...
public:
    ...
    bool hasCx() const { return m_cx != nullptr; }
    bool hasCy() const { return m_cy != nullptr; }
    bool hasR() const { return m_r != nullptr; }
    bool hasFx() const { return m_fx != nullptr; }
    bool hasFy() const { return m_fy != nullptr; }
...
public:
    ...
    bool hasX() const { return m_x != nullptr; }
    bool hasY() const { return m_y != nullptr; }
    bool hasWidth() const { return m_width != nullptr; }
    bool hasHeight() const { return m_height != nullptr; }
    bool hasPatternTransform() const { return m_patternTransform != nullptr; }
    bool hasPatternUnits() const { return m_patternUnits != nullptr; }
    bool hasPatternContentUnits() const { return m_patternContentUnits != nullptr; }
    bool hasViewBox() const { return m_viewBox != nullptr; }
    bool hasPreserveAspectRatio() const { return m_preserveAspectRatio != nullptr; }
    bool hasPatternContentElement() const { return m_patternContentElement != nullptr; }
